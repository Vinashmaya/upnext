      ...
      <div className="min-h-screen gradient-bg gradient-bg-dark">
        ...
        <div className="p-4">
          <div className="max-w-6xl mx-auto">
            {/* Header with status - Fixed layout to prevent glitches during refresh */}
            <div className="text-center mb-8 mt-8">
              <div className="inline-flex items-center justify-center gap-4 px-4 py-2 bg-background/50 rounded-full border text-muted-foreground min-w-[300px]">
                {/* Connection status with fixed width */}
            ...
            {/* Current Up Display */}
            <Card className="mb-8 border-4 border-primary shadow-2xl card-hover bg-gradient-to-br from-card to-card/80">
              <CardHeader className="brand-gradient text-primary-foreground text-center">
                <CardTitle className="text-3xl md:text-4xl font-bold">CURRENTLY UP</CardTitle>
              </CardHeader>
              <CardContent className="p-8 text-center">
                {currentEmployee ? (
                  <div>
                    <div className="text-6xl md:text-8xl font-bold text-gradient mb-6">{currentEmployee.name}</div>
